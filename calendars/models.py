...
class leave_type(models.Model):
    ...
    branch                        = models.ManyToManyField('OrganisationManager.brnch_mstr',blank=True,related_name='leave_types')
...
class LateinEarlyoutRequest(models.Model):
    ...
    employee     = models.ForeignKey("EmpManagement.emp_master",on_delete=models.CASCADE,related_name='lateinearlyout')
