...
class brnch_mstr(models.Model):
    ...
    br_city                   = models.CharField(max_length=50,blank=True, null=True)
    br_pincode                = models.CharField(max_length=20,blank=True, null=True)
    br_branch_nmbr_1          = models.CharField(max_length=20,blank=True, null=True)
