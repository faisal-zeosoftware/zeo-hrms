...
from .views import (EmpFamViewSet, EmpJobHistoryvSet, EmpViewSet,NotificationViewset,
                    ...
                    DocRequestTypeViewset,EmployeeByUserViewSet,EscalationRuleViewSet,ResignationEmailTemplateViewset,ResignationRequestNotificationViewSet,DocumentViewSet,ResignationRequestNotificationViewset
                    )
